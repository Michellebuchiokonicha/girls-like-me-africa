        ...
        <header className="absolute inset-x-0 top-0 z-50">
            <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div className="hidden lg:flex lg:gap-x-6">
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Books & Resources</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Meet a mentor</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Become a Mentor</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Financial Aid</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Valid Dreams</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">About</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Network</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Need Help?</a>

                </div>
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Sign Up <span aria-hidden="true">&rarr;</span></a>
                </div>
            </nav>
